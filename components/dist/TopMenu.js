...
var TopMenu = function () {
    return (React.createElement(React.Fragment, null,
        ...
        React.createElement("div", { className: "fixed z-50 hidden h-[64px] w-full bg-white md:flex " },
            React.createElement("div", { className: "flex flex-row" },
                React.createElement("div", { className: "navbar-start" },
                    ...
                    React.createElement("div", { className: "drawer-side " },
                        ...
                        React.createElement("ul", { className: "imrz-text menu w-full absolute bg-white p-4 overflow-hidden" },
                            React.createElement("li", null,
                                React.createElement("a", { href: "/agency" }, "Agency")),
                            React.createElement("li", null,
                                React.createElement("a", { href: "/products" }, "Products"))))),
                React.createElement("div", { className: " h-auto m-auto mr-10" },
                    React.createElement(link_1["default"], { href: "/" },
                        React.createElement("a", { className: "" },
                            React.createElement("img", { src: "/logo.svg", className: "w-full object-fill", alt: "Imrz Labs" })))),
                React.createElement("div", { className: " mr-[5px] flex items-center justify-end justify-items-stretch" },
                    React.createElement("a", { href: "#contact" },
                        React.createElement("button", { type: "button", className: "justify-self-end hover:bg-brand-gradient imrz-blue h-[40px] w-[120px] rounded-md object-scale-down text-tiny font-semibold uppercase text-white shadow transition ease-in-out hover:duration-150 sm:hidden" }, "Contact")),
                    React.createElement("a", { href: "#contact" },
