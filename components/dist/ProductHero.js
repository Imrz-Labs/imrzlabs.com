...
var ProductHero = function () {
    return (react_1["default"].createElement(react_1["default"].Fragment, null,
        react_1["default"].createElement("div", { className: "h-[90vh] sm:h-[80vh] bg-brand-gradient w-screen" },
            react_1["default"].createElement("div", { className: "pt-20 w-full text-white" },
                react_1["default"].createElement("div", { className: "m-auto mb-14 w-9/12" },
                    react_1["default"].createElement("img", { className: "flex h-[115px] w-auto lg:hidden", src: "/imrzproducts.svg", alt: "Imrz Products" }),
                    react_1["default"].createElement("img", { className: "m-auto hidden lg:flex", src: "/imrzproducts-mid.svg", alt: "Imrz Products" })),
                react_1["default"].createElement("h1", { className: "imrz-h1-hero" }, "We\u2019ve developed a number of Web3 focused products that demonstrate our innovation capability in the space."),
