        ...
        react_1["default"].createElement("div", { className: "h-[90vh] sm:h-[80vh] bg-brand-gradient w-screen" },
            react_1["default"].createElement("div", { className: "pt-20 w-full text-white" },
                react_1["default"].createElement("div", { className: "m-auto mb-14 w-9/12" },
                    react_1["default"].createElement("img", { className: "flex h-auto w-auto lg:hidden", src: "/imrzagency.svg", alt: "Imrz Agency" }),
                    react_1["default"].createElement("img", { className: "m-auto hidden lg:flex", src: "/imrzagency-mid.svg", alt: "Imrz Agency" })),
                react_1["default"].createElement("h1", { className: "imrz-h1-hero" }, "Use our experience, insight and agility to elevate your business and deliver future focused solutions."),
