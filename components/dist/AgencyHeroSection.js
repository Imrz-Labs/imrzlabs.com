    ...
    return (react_1["default"].createElement(react_1["default"].Fragment, null,
        react_1["default"].createElement("div", { className: "h-[90vh] sm:h-[80vh] bg-brand-gradient w-screen" },
            react_1["default"].createElement("div", { className: "pt-[110px] w-full text-white" },
                ...
                react_1["default"].createElement("h1", { className: "imrz-h1-hero mt-8" }, "Use our experience, insight and agility to elevate your business and deliver future focused solutions."),
