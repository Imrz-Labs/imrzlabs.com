...
const ContentCards = () => {
  return (
    <>
      <div className="shadow-3xl m-auto my-5 items-center justify-center rounded-3xl bg-white px-10 py-10 shadow-transparent 3xl:w-9/12 2xl:w-9/12 xl:w-11/12 lg:my-[-20px] md:my-20">
      ...
      <div className="shadow-3xl m-auto my-5 items-center justify-center rounded-3xl bg-white px-10 py-10 shadow-transparent 3xl:my-20 3xl:w-9/12 2xl:w-9/12 xl:w-11/12 lg:my-[-20px] md:my-20">
