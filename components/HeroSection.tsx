  ...
  return (
    <>
      ...
      <div className="absolute top-[30%] text-white">
        <h1 className="mx-auto w-full pb-5 text-center text-xl font-bold leading-[80px] 3xl:w-9/12 xl:w-10/12 xl:text-lg lg:w-10/12 md:w-10/12 md:text-base sm:w-full sm:text-sm">
          Making Emerging Technologies <br />
          Accessible To All
        </h1>
        <p className="mx-auto w-7/12 text-center text-sm leading-[46px] 3xl:w-7/12 3xl:px-10 xl:w-10/12 lg:w-10/12 md:w-10/12 md:text-xs sm:w-11/12 sm:text-tiny ">
