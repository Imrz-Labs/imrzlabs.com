...
const privacy = () => {
  return (
    <>
      <Head>
        <title>Imrz Labs | Privacy Policy</title>
        <meta
          name="description"
      ...
      <div className="shadow-3xl m-auto my-28 h-auto items-center justify-center rounded-3xl bg-white px-10 py-10 3xl:w-9/12 2xl:w-9/12 xl:w-11/12 lg:my-[-20px] md:my-20">
        <p className="">
          IMRZ LABS LTD - Company Number:11332225 Registered Office Address - 10
          Grange Road, West Kirby, Wirral, Merseyside, CH48 4HA UK Contact
          Email: Info@IMRZLABS.com
        </p>

        <p className="">
          IMRZ Labs operates the www.IMRZlabs.com website, which provides the
          SERVICE.
        </p>
        ...
        <p className="py-5 font-semibold ">
          ...
          anyone decided to use our Service, the Www.IMRZlabs.com website.
        </p>
        ...
        <p className="py-5 font-semibold ">
          ...
          Terms and Conditions, which is accessible at www.IMRZlabs.com, unless
        ...
        <h2 className="text-base font-bold md:text-sm">Log Data</h2>
        ...
        <h2 className="text-base font-bold md:text-sm">Cookies</h2>
        ...
        <p className="py-5 font-semibold ">
          ...
          <a href="https://www.termsfeed.com/blog/sample-cookies-policy-template/#What_Are_Cookies">
            "Cookies" article from the TermsFeed website
          </a>
          .
        </p>

        <h2 className="text-base font-bold md:text-sm">Service Providers</h2>
        ...
        <h2 className="text-base font-bold md:text-sm">Security</h2>
        ...
        <h2 className="text-base font-bold md:text-sm">Links to Other Sites</h2>
        ...
        <p className="py-5 font-semibold ">Children's Privacy</p>
        ...
        <h2 className="text-base font-bold md:text-sm">Contact Us</h2>
