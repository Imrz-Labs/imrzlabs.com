...
const privacy = () => {
  return (
    ...
    <div className='h-auto m-auto my-28 px-10 py-10 bg-white items-center justify-center rounded-3xl shadow-3xl 3xl:w-9/12 2xl:w-9/12 xl:w-11/12 lg:my-[-20px] md:my-20'>
      ...
      <p className="py-5 font-semibold ">
        ...
        decided to use our Service, the Www.IMRZlabs.com website.
      </p>
      ...
      <h2 className='text-base font-bold md:text-sm'>Information Collection and Use</h2>
      ...
      <h2 className='text-base font-bold md:text-sm'>Changes to This Privacy Policy</h2>
