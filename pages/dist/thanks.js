...
var thanks = function () {
    ...
    return (react_1["default"].createElement(react_1["default"].Fragment, null,
        ...
        react_1["default"].createElement("div", { className: "m-auto bg-white flex h-screen w-full flex-col items-center justify-center gap-y-5 overflow-hidden pb-48 text-center" },
