...
var team = function team() {
  return react_1["default"].createElement(react_1["default"].Fragment, null, react_1["default"].createElement(head_1["default"], null, react_1["default"].createElement("title", null, "Imrz Ventures | Reality is your canvas!"), react_1["default"].createElement("meta", {
    name: "description",
    ...
    className: "bg-brand-gradient inset-x-0 top-0 flex h-screen opacity-80 mix-blend-hue"
  })), react_1["default"].createElement("div", {
    className: "absolute top-[30%] w-full text-white"
  }, react_1["default"].createElement("div", {
    ...
    className: "my-14 mx-auto ml-48 flex w-5/12 items-center justify-start text-left text-base font-bold 3xl:w-7/12 xl:w-10/12 lg:w-10/12 md:w-10/12 md:text-xs sm:w-11/12 sm:text-tiny "
  }, "The IMRZ eco-system expands daily and includes a roster of experience and innovation."), react_1["default"].createElement("a", {
    href: "http://"
  ...
  }, "JOIN OUR DISCORD"))), react_1["default"].createElement("div", {
    className: "mt-[-33%]"
  }, react_1["default"].createElement(image_1["default"], {
    ...
    height: 100,
    layout: "responsive"
  })), react_1["default"].createElement("div", null, react_1["default"].createElement(components_1.FormArea, null)), react_1["default"].createElement("div", null, react_1["default"].createElement(components_1.Footer, null)));
};
